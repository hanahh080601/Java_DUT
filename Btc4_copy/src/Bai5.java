...
public class Bai5 extends Frame implements ActionListener
{
	...
	public void GUI()
	{
		lb = new Label("TIM SO TRUNG GIAN TRONG 3 SO");
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource() == ketqua)
		{
			...
			if(b < a && a < c || c < a && a < b)
				txtkq.setText(Float.toString((float)a));
			else if(a < b && b < c || c < b && b < a)
				txtkq.setText(Float.toString((float)b));
	...
	{
		new Bai5("Tim so trung gian trong 3 so");
	}
}
