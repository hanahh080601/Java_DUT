	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource() == ketqua)
		{
			...
			if(a == 0)
			{
				if(b == 0)
				{
					if(c == 0) txtkq.setText("Phuong trinh vo so nghiem");
					else txtkq.setText("Phuong trinh vo nghiem");
				}
				else
				{
					txtkq.setText(Float.toString((float)-c/b));
				}
			}
			else
			{
				...
				if(delta > 0)
				{
		            ...
		            txtkq.setText("PT có 2 nghiệm : " + " x1 = " + (Float.toString((float)x1) + " x2 = "+ (Float.toString((float)x2))));
				}
				else if( delta == 0) 
				{
					x1 = ( -b / (2*a));
					txtkq.setText("PT có nghiệm kép x1 = x2 = " + (Float.toString((float)x1)));
				}
				else 
				{
